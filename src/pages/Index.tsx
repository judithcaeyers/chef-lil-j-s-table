...
const Index = () => {
  ...
  return (
    <div className="max-w-[650px] mx-auto px-6 py-16 md:px-10 md:py-20 text-center">
      ...
      {renderEvents(events.filter((e) => !e.past))}

      {/* Past Dinners */}
      {events.some((e) => e.past) && (
        <>
          <div className="my-16 w-[60px] h-px bg-foreground opacity-20 mx-auto" />
          <h2 className="font-display text-4xl md:text-[42px] mb-16" style={{ WebkitTextStroke: '0.5px currentColor' }}>{t("pastDinners")}</h2>
          {renderEvents(events.filter((e) => e.past))}
        </>
      )}
      ...
      <div ref={menuRef}>
        ...
        <p className="mt-16 text-[13px] tracking-[1px] opacity-70 leading-relaxed whitespace-pre-line">
          {t("dietaryNote")}
        </p>
      ...
      <div className="mt-10 text-sm">
        ...
        <a href="https://www.instagram.com/judiths_dinner_club/" target="_blank" rel="noopener noreferrer" className="border-b border-foreground text-foreground no-underline">
          {t("recipesNotes")}
        </a>
      </div>
