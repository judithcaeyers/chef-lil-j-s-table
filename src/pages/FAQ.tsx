...
const faqItems = [
  {
    q: { en: "Can I take the chef home afterwards so she cooks for me every day?", nl: "Kan ik de chef mee naar huis nemen zodat ze elke dag voor mij kookt?" },
    a: {
  ...
  },
  {
    ...
    a: {
      en: "Absolutely. Some guests come with friends, others come alone, both work beautifully.",
      nl: "Absoluut. Sommige gasten komen met vrienden, anderen alleen, allebei werkt prima.",
    },
  },
  {
